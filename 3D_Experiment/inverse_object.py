...
class InverseTransform:
    ...
    def __inverse_residuals(self, img_pt_left, img_pt_right, predicted_object_pt):
        """
        Residual for the preidction based on the inputted image point from the left and right camera

        :param img_pt_left:             Image plane coordinate from the left camera (X, Y)
        :param img_pt_right:            Image plane coordinate from the right camera (X, Y)
        ...
        xi, yi, zi = np.intp(predicted_object_pt)
